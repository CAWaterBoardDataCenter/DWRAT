...
def demand_processing(demand_path, file_name):
    ...
    cols = ['APPLICATION_NUMBER', 'RIPARIAN', 'BASIN', 'MAINSTEM', 'UPPER_RUSSIAN', 'PRIORITY',
    ...
    # NOW READ IN THE DEMAND DATASET, specify columns above, set index to APPLICATION_NUMBER
...
config_file = pd.read_excel("config_file.xlsx", index_col = "INPUT_NAME")
...
mainstem_basins = ["R_14_M", "R_15_M", "R_16_M", "R_17_M", "R_18_M", "R_19_M", "R_21_M", "R_24_M"]
